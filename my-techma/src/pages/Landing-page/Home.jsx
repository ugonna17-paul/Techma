...
const Home = () => {
    ...
    const texts = [
        "Your CRM and AI Experts",
        "Not just AI.",
        "Not just CRM.",
        "We craft complete digital experiences that scale.",
    ];
                ...
                <div className="why-choose-container">
                    <div className="why-choose-content" data-aos="fade-right">
                        <h2 className="why-title">
                            Why Choose <span>BrandNest</span>
                        </h2>
                        <p className="why-description">
                            Why choose BrandNest? For our deep expertise in diverse IT domains,
