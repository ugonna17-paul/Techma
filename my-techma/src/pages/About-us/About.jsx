   ...
   const reviews = [
        {
            ...
            quote: "It’s a great pleasure working with BrandNest because they understand my needs. Their team is always dedicated to delivering the best results in every aspect. I am happy I found them after several failed experiences before.",
        },
        {
            name: 'Victor',
            title: 'CEO, Pottv',
            quote: "Outstanding to work with and very knowledgeable. BrandNest saved me a LOT of time. Knew what they were doing and how to make things better. I will be using many more times for all future projects.",
        },
        {
            name: 'Iyanu',
            title: 'CEO, Aila Beauty Hub',
            quote: "Working with BrandNest has been an outstanding experience. They understood my needs right away and delivered beyond expectations. After several setbacks with others, I finally feel confident with their reliable support.",
        },
    ];
      ...
      <section className="about-section">
        <div className="about-container">
          ...
          <div className="about-text" data-aos="fade-left" data-aos-delay="300">
            ...
            <button className="about2-btn" data-aos="zoom-in" data-aos-delay="700">
              Learn More →
            </button>
          </div>
        </div>
        ...
        <div className="misson-container">
          <div className="misson-text" data-aos="fade-right" data-aos-delay="100">
            ...
            <p data-aos="fade-up" data-aos-delay="300">
              ...
              we are committed to significantly reducing unemployment in Benin. We achieve this by hiring and training talented individuals, contributing
      ...
      <div className="timeline-container">
        ...
        <div className="timeline-wrapper" ref={timelineRef}>
          ...
          {[
            ...
            { date: "Dec 2023", text: "BRANDNEST opens its doors." },
          ].map((event, i) => (
            <div
              key={i}
